...
const Navbar = ({setFilterType, filterType, searchTerm, setSearchTerm, setSelectedEmail}) => {
  ...
  return (
    <nav className='Navbar flex gap-x-40 pt-4  ml-24 font-medium'>
        ...
        <input type = 'text' placeholder='Search by name.....' className='border border-[#CFD2DC] w-[30%] rounded-2xl p-2' value = {searchTerm} onChange={(e) => {setSearchTerm(e.target.value); setSelectedEmail(null)}}/>
    </nav>
  )
}
